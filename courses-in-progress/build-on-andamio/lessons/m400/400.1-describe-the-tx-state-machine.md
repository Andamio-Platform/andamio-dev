...
module: 400
order: 1
title: "Describe each step of the Andamio TX state machine"
...
**Lesson 400.2: Why `updated` is the only safe TX status for refetching data.** The middle status (`confirmed`) is a trap. Next lesson explains why.
