...
module: 100
order: 2
title: "Install and configure the Andamio CLI"
lesson_type: how_to_guide
bloom_level: apply
estimated_time_min: 8
prerequisites: ["100.1"]
unlocks: ["100.3"]
evidence_type: cli_version_output
---
...
Run the install. Run `andamio --version`. Configure your API key. You're done when the version prints and `andamio config get api-key` returns your key.
...
**Lesson 100.3: Fund a preprod wallet.** You have the tool; next you need test ADA to spend with it.
