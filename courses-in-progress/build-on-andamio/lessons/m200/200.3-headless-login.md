...
module: 200
order: 3
title: "Log in headlessly with a .skey file"
lesson_type: how_to_guide
bloom_level: apply
estimated_time_min: 8
prerequisites: ["200.2"]
unlocks: ["200.4"]
evidence_type: cli_status_output
---
...
**Lesson 200.4: Verify an Attestation JWT offline.** How third-party apps confirm wallet ownership of an alias without calling the Andamio API on every check.
