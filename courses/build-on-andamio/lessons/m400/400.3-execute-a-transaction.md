...
module: 400
order: 3
title: "Execute an Andamio transaction through its full state machine"
...
**Lesson 400.4: Diagnose and respond to TX failures.** What happens when the five steps don't work — failure modes, recognition, and recovery.
