...
module: 500
order: 2
title: "Compute an slt_hash for a course module"
...
**Lesson 500.3: Publish a course module on-chain.** You have a hash. Next: mint it as a module token so students can earn credentials against it.
