...
module: 500
order: 1
title: "How Andamio courses are structured"
...
**Lesson 500.2: Compute an `slt_hash` for a course module.** You know the hash exists and what it's for. Next lesson: how it's computed, and why that computation matters.
