...
module: 700
order: 5
title: "Critique the Andamio developer experience"
...
This is the last lesson. The Module 700 assignment collects your capstone integration, your cost estimate, your failure-handling approach, and your critique. After that: seven module credentials, each tied to a specific `slt_hash`, each verifiable forever.

Open `lessons/m700/assignment.md` or go to the assignment page in the Andamio app.
