...
This is the most complex transaction on Andamio: six mints, six validator UTxOs, a stake account registration, and the treasury deposit. Cost: ~148 ADA — a 100 ADA service fee, ~44.6 ADA in minUTxO deposits (including a 5 ADA treasury reserve), 2 ADA stake registration and ~1.3 ADA tx fee — plus the treasury deposit. Name every manager here: a manager added after creation pays a further 10 ADA service fee.
...
|-------------|---------|------|
| `project_create` | Owner | ~148 ADA (100 service + ~44.6 deposits + 2 stake registration + ~1.3 fee) + treasury deposit |
