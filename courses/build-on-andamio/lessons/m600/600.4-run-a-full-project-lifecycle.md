...
This is the most complex transaction on Andamio: six mints, six validator UTxOs and a stake account registration. The treasury is created with a 5 ADA reserve and no task funds. Cost: ~148 ADA — a 100 ADA service fee, ~44.6 ADA in minUTxO deposits (including a 5 ADA treasury reserve), 2 ADA stake registration and ~1.3 ADA tx fee. You fund the treasury in the next transaction. Name every manager here: a manager added after creation pays a further 10 ADA service fee.
